...
I made this, because we need utilities that would be portable and work everywhere accross any Linux distribution, like some `coreutils`, `sed`, `gawk`, `find`, `curl` and `wget` tools.  
